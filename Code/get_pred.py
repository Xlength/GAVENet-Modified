...
parser.add_argument('-p', '--train_path', type=str, default="Log\\GAVE_trainv2_GAVENet_lr1e-04_RRLoss-BCE3Loss_bc64")
parser.add_argument('-i', '--images_path', type=str, default="Data/GAVE/training/images")
parser.add_argument('-m', '--masks_path', type=str,default="Data/GAVE/training/masks")
#parser.add_argument('-i', '--images_path', type=str, default="Data/GAVE/validation/images")
#parser.add_argument('-m', '--masks_path', type=str,default="Data/GAVE/validation/masks")
parser.add_argument('-t', '--test_name', type=str, default="test")
#parser.add_argument('-t', '--test_name', type=str, default="validation")
