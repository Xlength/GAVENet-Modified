...
parser.add_argument('-p', '--pred_path', type=str, default="Log\GAVE_trainv1_GAVENet_lr1e-04_RRLoss-BCE3Loss_bc64\Pred/test", help='Path to the predicted images')
#Please change this path
parser.add_argument('-g', '--gt_path', type=str, default="Data/GAVE/training/av", help='Path to the ground truth images')
# parser.add_argument('-g', '--gt_path', type=str, default="Data/GAVE/validation/av", help='Path to the ground truth images')
parser.add_argument('-m', '--mask_path', type=str, default="D:/GAVE-main/Data/GAVE/training/masks", help='Path to the ROI masks')
parser.add_argument('-n', '--n_paths', type=int, default=100)  # 100 for formal testing, regarding to times consumption
parser.add_argument('-s', '--shape', type=str, default="1536x1024", help='Shape of the images for the evaluation. Format: "heightxwidth"')
