...
parser.add_argument('--num_folds', type=int, default=5) #加点容错看看
...
parser.add_argument('--version', type=str, default='trainV2')
...
# if dataset == 'GAVE':
    ...
    # ]
if dataset == 'GAVE':
    images = [f"g_{i:03d}" for i in range(1, 51)]   # 生成 g_001 - g_050
